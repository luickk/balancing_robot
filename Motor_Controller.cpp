...
Motor_Controller::Motor_Controller(int ena, int in1, int in2, int enb, int in3, int in4, double motorAConst, double motorBConst)
{
...
void Motor_Controller::move(int leftSpeed, int rightSpeed, int minAbsSpeed)
{
    if (rightSpeed < 0)
    {
...
void Motor_Controller::move(int speed, int minAbsSpeed)
{
    int direction = 1;
...
void Motor_Controller::move(int speed)
{
    if (speed == _currentSpeed) return;
...
void Motor_Controller::turnLeft(int speed, bool kick)
{
...
void Motor_Controller::turnRight(int speed, bool kick)
{
...
void Motor_Controller::stopMoving()
{
    digitalWrite(_in1, LOW);
    digitalWrite(_in2, LOW);
    digitalWrite(_in3, LOW);
